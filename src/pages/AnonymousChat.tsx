...
const AnonymousChat = () => {
  ...
  const handleQuestionClick = (qa: QuestionResponse) => {
    ...
    setTimeout(() => {
      ...
      const randomResponse = qa.responses[Math.floor(Math.random() * qa.responses.length)];
            ...
            <div className="info-card mt-4">
              ...
              <div className="info-content">
                ...
                <p className="info-text">
                  Cuộc trò chuyện của bạn được bảo mật. Không có thông tin cá nhân nào được thu thập hoặc chia sẻ.
                </p>
              </div>
            </div>
